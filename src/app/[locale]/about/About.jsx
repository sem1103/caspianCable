...
const About = () => {
  ...
  const { aboutContent, teams, environmentalPolicy, fetcAboutContent } = useDataStore();
...
console.log(teams);
  ...
  return (
    <div className={s.about_page}>
        ...
        <div className='main__container'>
          <div className={s.banner_left_side}>
            <div className={s.banner_top_img}>
              ...
              >
                {
                  aboutContent[0]?.additional_images?.map(item => {
                    return (
                      <SwiperSlide>
                        <img src={item.image} />
                      </SwiperSlide>
            ...
            <div className={`${s.banner_bottom_images} banner_bottom_images`}>
              <Swiper
      ...
      <section className={`main__container ${s.out__team}`}>
        <h2>Bizim komanda</h2>
