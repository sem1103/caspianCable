...
export default function Laboratory() {
    ...
    return (
        <section className={s.laboratory}>
            <div className='main__container'>
                <div className={s.devices}>
                    ...
                    <div className={s.devices__wrapper}>
                        {
                            laboratoryDevices?.results?.map(item => {
                                return (
                                    <div className={s.devices}>
                                        <img src={item.image} alt="" />
                                        <h4>{item.name}</h4>
                                        <div className={s.device__desc} dangerouslySetInnerHTML={{ __html: item.content }} />

                                        <Link href={`/laboratory/${item.id}`} />
                                    </div>
                                )
                            })
                        }
